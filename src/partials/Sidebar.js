    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink exact="true" to="/" className="inline-flex items-center">
            ...
            <h1 className="text-white ml-2">SG Stock Webapp</h1>
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("orders-basket") && "bg-gray-900"
                }`}
              >
                <NavLink
                  exact="true"
                  to="/orders-basket"
                  className={`block text-gray-200 hover:text-white truncate transition duration-150 && 'hover:text-gray-200'}`}
                >
                  <div className="flex items-center">
                    <svg className="flex-shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-gray-400 ${
                          pathname.includes("orders-basket") &&
                          "text-indigo-300"
                        }`}
